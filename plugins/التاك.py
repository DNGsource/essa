...
@essa .iq_cmd(pattern="تكرار حزمه الملصقات$",)
...
@essa .iq_cmd(    pattern="تكرار_احرف ([\s\S]*)",)
...
@essa .iq_cmd(    pattern="تكرار_كلمه ([\s\S]*)",)
async def tmeme(event):
...
@essa .iq_cmd(pattern=f"{MUQT} ([\s\S]*)",)
