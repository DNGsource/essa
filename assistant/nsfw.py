...
@ESSA.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@ESSA.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@ESSA.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
